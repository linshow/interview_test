    ...
    <div class="container">
        <div class="example">
            <div class="col-md-offset-4 col-md-4">
                <h4>
                    <center><strong>建立新帳號</strong></center>
                </h4>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="accountName" placeholder="請輸入名字" required
                        oninvalid="setCustomValidity('請輸入名字')" oninput="setCustomValidity('')">
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="birthDate" placeholder="請輸入生日" required
                        oninvalid="setCustomValidity('請輸入生日')" oninput="setCustomValidity('')">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">信箱</span>
                    <input type="text" class="form-control" name="accountEmail" placeholder="請輸入信箱" required
                        oninvalid="setCustomValidity('請輸入信箱')" oninput="setCustomValidity('')">
                </div>
                <div class="input-group">
                ...
                <center>
                    ...
                    <button type="button" class="btn btn-warning"
                        onclick="location.href='/interview_test/index.php/users'">離開</button>
                </center>
